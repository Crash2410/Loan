...
function () {
  ...
  _createClass(Download, [{
    key: "downLoadItem",
    value: function downLoadItem(url) {
    ...
    value: function initMask() {
      ...
      function createMask(event) {
        var matrix = '+1 (___) ___-____',
            ...
            val = this.value.replace(/\D/g, ''); // Запрещаем пользователю удалять шаблон ввода номера
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          e.preventDefault(); // Добавление блока с уведомлением о состоянии отправки данных

          var statusMessage = document.createElement('div');
          statusMessage.style.cssText = "\n                    margin-top: 15px;\n                    font-size: 18px;\n                    color: grey;\n                ";
          form.parentNode.appendChild(statusMessage);
          statusMessage.textContent = _this.message.loading; // Формирование данных для отправки

          var formData = new FormData(form); // Отправка данных
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        ...
        */
        ...
        } catch (error) {} // Показ плеера по нажатию на кнопку
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              _this.overlay.style.display = 'flex'; // Изменение видео при нажатии на разные кнопки
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playBtn = this.activeBtn.querySelector('svg').cloneNode(true); // Открытие доступа к следующему видео, после просмотра первого
    ...
    value: function init() {
      if (this.btns.length > 0) {
        ...
        firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // Инициализация триггеров
...
function (_Slider) {
  ...
  function MainSlider(btns, prevBtns) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, prevBtns));
  } // Показ слайдов
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        this.hanson.style.opacity = '0'; // Показ всплывающего блока при попадании на 3-й слайд
      ...
      } catch (e) {} // По умолчанию показ первого слайда
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlider() {
      ...
      this.slides[0].classList.add(this.activeClass); // Работа с заголовками слайдеров
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this3.decorizeSlider();

        _this3.moveButtonsToEnd();
      });
      var playing = false; // Автоматическое переключение слайдов

      if (this.autoplay) {
        playing = Object(core_js__WEBPACK_IMPORTED_MODULE_9__["setInterval"])(function () {
          _this3.nextSlide();
        }, 3000);
